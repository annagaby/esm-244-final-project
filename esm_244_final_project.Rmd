...
top_filtered2 <- shorebirds %>% 
  ...
  filter( Species == top_by_year2$Species[1] | Species == top_by_year2$Species[2] | Species == top_by_year2$Species[3] | Species == top_by_year2$Species[4] | Species == top_by_year2$Species[5] | Species == top_by_year2$Species[6] | Species == top_by_year2$Species[7] | Species == top_by_year2$Species[8] | Species == top_by_year2$Species[9]) %>% 
  arrange(Species, -count)

top_graph <- ggplot( top_filtered2, aes( x = Month, y = count)) + geom_col() + 
facet_wrap(~Species) +
theme_classic() +
